...
if __name__ == '__main__':
    ...
    gr.Interface(
        process,
        inputs=[gr.Image(type="pil", label="Input", image_mode='L'), gr.Slider(200, 1000,label='Step numbers', info="The diffusion model's step count directly impacts image quality: more steps lead to higher quality images.")],
